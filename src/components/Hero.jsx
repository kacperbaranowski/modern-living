...
export default function Hero() {
  ...
  return (
    <section ref={ref} style={{ height: '100vh', position: 'relative', overflow: 'hidden', color: 'white', backgroundColor: '#111' }}>
      
      {/* Background Image Parallax */}
      <motion.div style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '120%', y, zIndex: 0 }}>
        <img src={heroImg} alt="Hero" style={{ width: '100%', height: '100%', objectFit: 'cover', opacity: 0.6 }} />
      </motion.div>
      ...
      {/* Content */}
      <motion.div 
        style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', zIndex: 10, display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', textAlign: 'center', opacity }}
      >
        <motion.span 
      ...
      >
        <span style={{ fontSize: '0.8rem', textTransform: 'uppercase', letterSpacing: '0.1em', opacity: 0.7 }}>Scroll</span>
      </motion.div>
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        borderRadius: '50%', // Circle/Organic shape
        zIndex: 5,
        pointerEvents: 'none'
      }}
    />
